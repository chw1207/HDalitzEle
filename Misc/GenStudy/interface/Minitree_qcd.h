...
public:
    Minitree_qcd(){};
    Minitree_qcd(const char *outpath)
    {
    ...
    void FillMinitree(TreeReader &data, Event_qcd &event);
};

void Minitree_qcd::Refresh()
{
    GsfIdx.clear();
    gsfPt_reco.clear();
    gsfEta_reco.clear();
...
void Minitree_qcd::SetMinitree(TString treename)
{
...
void Minitree_qcd::FillMinitree(TreeReader &data, Event_qcd &event)
{
    Refresh();
    // GEN information
