...
def get_options():
  ...
  parser.add_option("--xvar", dest="xvar", default="CMS_higgs_mass,M_{ee#gamma},GeV", help="X-variable: name,title,units")
  parser.add_option("--nBins", dest="nBins", default=65, type='int', help="Number of bins")
  parser.add_option("--pdfNBins", dest="pdfNBins", default=2600, type='int', help="Number of bins")
