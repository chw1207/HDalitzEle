...
# e.g. /data5/ggNtuples/V10_06_30_01/job_UL18_QCD_HT50to100/*.root
def get_name(mode):
    ...
    ntuple =  args.prefix + "job_{}_QCD_{}/*.root".format(ext, end)
    return ntuple
...
def main():
    ...
    for mode in decay_modes:
        ...
        skimfile = "./miniTree/{}/miniTree_QCD_{}_{}.root".format(args.era, mode, args.era)
        # start executing the xAna
        try:
            xAnaGenQCD(infile, skimfile, args.era, mode)
...
if __name__ == "__main__" :
    ...
    ROOT.gROOT.ProcessLine(".L xAnaGenQCD.C+O") # compile the macro with ACLiC
    from ROOT import xAnaGenQCD
