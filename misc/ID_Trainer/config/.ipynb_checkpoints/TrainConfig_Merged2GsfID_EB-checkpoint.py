...
OutputDirName = "./Results/Output_Merged2GsfID_EB_2017_dask"
...
CommonCut = "(elePresel == True) and (nVtx > 1) and (nGsfMatchToReco >= 2) and (Class != 'Merged-1Gsf')"
#####################################################################
Classes = ["Merged-2Gsf", "DYJets", "GJets", "QCD"]
